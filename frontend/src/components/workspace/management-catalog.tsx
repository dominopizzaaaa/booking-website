...
import { isManagerWorkspace, type Instructor, type Location, type Service, type ServiceLocation, type VenueCandidate } from '@/lib/types';
...
function LocationEditor({ location, canManage, refresh, onClose }: { location: Location | null; canManage: boolean; refresh: () => Promise<void>; onClose: () => void }) {
