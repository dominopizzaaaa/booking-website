...
import type { ManagerWorkspace, Payment } from '@/lib/types';
...
export function PackagesView({ data, refresh }: ManagementProps) {
  ...
  return <>
    <PageHeading title="Lesson packages" description="More time to grow. Keep track of every student's credits, payments, and renewals." action={() => setCreate(true)} actionLabel="Sell package" />
